...
# Uso:
#   bash comecar.sh
#   curl -fsSL https://raw.githubusercontent.com/sysadmin-stack/deskcomm-bootstrap/main/comecar.sh | bash
#
set -euo pipefail
...
comando_de_instalacao() {
  ...
  Já dentro do servidor, cole isto:
       ...
       curl -fsSL https://raw.githubusercontent.com/sysadmin-stack/deskcomm-bootstrap/main/instalar.sh | bash

  O bootstrap pede uma credencial técnica somente de leitura, clona o núcleo
  privado sem colocar o token na URL e entrega o restante ao instalador: cria o banco,
